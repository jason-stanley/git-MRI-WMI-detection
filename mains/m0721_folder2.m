...
for loopImage = loopImageRange
    ...
    pathImage = ['../data/Folder-2/secondBC0147-3-', num2str(loopImage), '-3.png'];
    ...
    %         subplot(222), imshow(imgRawColorBack); 
        ...
        pathImageOut = ['../data/Folder-2/secondBC0147-3-', num2str(loopImage), '-4.png'];
...
%         subplot(222), imshow(imgRawColorBack); 
    ...
    if(booRunDisplayResult)
        run dis_result_folder2.m
    end
...
% replaced by imdilate function (faster than that)
